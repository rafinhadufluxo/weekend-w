<?php include "includes/cabecalho.php"; ?>
    ...
    <section>
        <div class="container">
            <div class="shadow">
                <div class="content1">
                    <a href="compraTrack.php" class="tomorrowland-alfter">
                        <div>
                    ...
                    <a href="VozCompra.php" class="tomorrowland-alfter2">
                ...
                <div class="content2">
                    <div class="image">
                        <img src="Img/vintage/lindo.jpg" alt="" style="width: 500px; height: 400px;">
                    </div>
                    <div class="text2020">
                        <p>24 a 25 - CTG Queen</p>
                        <br>
                        <h1 class="t-heading">Alfter Party Reveillon</h1>
                        <br>
                        ...
                        <p>2º Lote: R$ 150,00</p>

                        <br><br><br>
                        <div class="group-button">
                            <a href="login.php" class="button1">Comprar <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="content3">

                    <p>Veja, o clipe do alfter que rolou na ultima festa da Weekend Warriors !</p>
                    <br>
                    <br>
